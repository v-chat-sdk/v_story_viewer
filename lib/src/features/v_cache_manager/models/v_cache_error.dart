...
sealed class VCacheError implements Exception {
  const VCacheError(this.message, this.url);
  ...
  @override
  String toString() => 'VCacheError: $message (url: $url)';
}

/// Network-related download errors
class VCacheNetworkError extends VCacheError {
...
class VCacheFileSystemError extends VCacheError {
  const VCacheFileSystemError(super.message, super.url);
}

/// Asset loading errors
class VCacheAssetError extends VCacheError {
  const VCacheAssetError(super.message, super.url);
}

/// Timeout errors during download
class VCacheTimeoutError extends VCacheError {
...
class VCacheValidationError extends VCacheError {
  const VCacheValidationError(super.message, super.url);
}

/// Errors that occurred after max retry attempts
class VCacheRetryExhaustedError extends VCacheError {
